...
const WEEK_DAYS = 7
const SCREEN_H_PADDING = (32 * 2) / 5

export const DAY_MARGIN_BETWEEN = 8
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS) - (SCREEN_H_PADDING + 5)
...
export default function HabitDay({ date, amountCompleted = 0, amountOfHabits = 0, ...rest }:HabitDayProps) {
